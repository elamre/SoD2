            ...
            for (int x = 0; x < width; x++) {
                ...
                switch (rgb) {
                    case 0xff808080:
                        ...
                        break;
                    default:
                        tiles[x + y * width] = new EmptyTile(x, y);
                        break;
                }
            }
        }
            ...
            for (int x = 0; x < width; x++) {
                ...
                switch (rgb) {
                    case 0xff808080:
                        break;
                    case 0xffff0000:
                        entities[x + y * width] = new SpeedPickup(entityManager.getNextSinglePlayerId(), x, height - y - 2);
                        break;
                    case 0xff00ff00:
                        entities[x + y * width] = new HearthPickup(entityManager.getNextSinglePlayerId(), x, height - y - 2);
                        break;
                    case 0xff0000ff:
                        entities[x + y * width] = new CompassPickup(entityManager.getNextSinglePlayerId(), x, height - y - 2);
                        break;
                    case 0xff000000:
                        entities[x + y * width] = new BulletPickup(entityManager.getNextSinglePlayerId(), x, height - y - 2);
                        break;
                }
            }
        }
